...
const NAVIGATION = [
  {
    ...
    items: [
      ...
      { id: 'team', label: 'Team Management', icon: 'solar:users-group-two-rounded-linear', path: '/dashboard/team' },
    ]
  },
];
...
const Sidebar = () => {
  ...
  const itemPadding = density === 'compact' ? 'px-3 py-1.5' : density === 'spacious' ? 'px-3 py-4' : 'px-3 py-3';

  return (
    <div className="w-[260px] h-full bg-[#FFFFFF] dark:bg-[#0B0F1A] border-r border-[#ECEDEF] dark:border-white/5 flex-col hidden lg:flex shrink-0 z-10">
      <div className="h-[72px] px-6 flex items-center border-b border-[#ECEDEF] dark:border-white/5">
        <RightTechLogo />
      </div>
              ...
              <div className="space-y-1">
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 ${itemPadding} rounded-[10px] transition-all duration-200 relative overflow-hidden group ${
                      isActive 
...
const Topbar = () => {
  ...
  // Find the current navigation item to get its label
  ...
  return (
    <div className="h-[72px] bg-white dark:bg-[#0B0F1A]/80 border-b border-[#ECEDEF] dark:border-white/5 flex items-center justify-between px-8 shrink-0 z-10 transition-all duration-500">
      <div className="flex items-center">
        <h1 className="text-[20px] font-semibold text-[#111111] tracking-tight">{pageTitle}</h1>
      </div>
      ...
      <div className="flex items-center gap-6">
        <div className="relative group hidden md:block">
          ...
          <input 
            ...
            className="w-[320px] h-10 pl-10 pr-4 bg-[#F7F7F8] border border-transparent rounded-[10px] text-[14px] text-[#111111] placeholder:text-[#8B93A7] focus:outline-none focus:bg-white focus:border-[#D40073] focus:ring-[3px] focus:ring-[rgba(212,0,115,0.1)] transition-all font-medium"
          />
        </div>
                        ...
                        <DealerWorkflowProvider>
                          <RetailerProvider>
                            <OrderWorkflowProvider>
                              <div className="flex h-screen w-full bg-[#F7F7F8] dark:bg-[#0B0F1A] font-sans overflow-hidden">
                                <Sidebar />
