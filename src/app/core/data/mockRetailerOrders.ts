...
export const MOCK_RETAILER_ORDERS: RetailerOrder[] = [
  ...
  },
  {
    ...
    credStatus: 'Active',
    date: 'Today, 10:15 AM',
    trackingToken: 'RT-1943',
    deliveryAddress: 'Kumasi, Central Market',
    orderNotes: 'Urgent delivery for retail stock.',
    createdAt: '2026-03-28T10:15:00Z',
    updatedAt: '2026-03-28T10:30:00Z',
    items: [{ productId: 'PRD-001', name: 'Portland Cement 50kg', qty: 10, unitPrice: '85 GHS', lineTotal: '850 GHS' }],
  },
  {
    id: 'ORD-8975',
    customer: 'Elite Homes',
    type: 'Wholesale',
    amount: '5,600 GHS',
    payStatus: 'Paid',
    paymentMethod: 'Bank Transfer',
    ...
    credStatus: 'N/A',
    date: 'Today, 11:00 AM',
    deliveryAddress: 'East Legon, Trassaco',
    orderNotes: 'Premium construction project.',
    createdAt: '2026-03-28T11:00:00Z',
    updatedAt: '2026-03-28T11:15:00Z',
    items: [{ productId: 'PRD-005', name: 'Roofing Sheets (Aluzinc)', qty: 16, unitPrice: '350 GHS', lineTotal: '5,600 GHS' }],
  },
  {
    id: 'ORD-8974',
    customer: 'Ofori & Co',
    ...
    deliveryAddress: {
      ...
      contactPhone: '+233 24 555 6666'
    },
    orderNotes: 'Customer will pay Cash on Delivery.',
    createdAt: '2026-03-28T11:30:00Z',
    updatedAt: '2026-03-28T11:35:00Z',
    items: [{ productId: 'PRD-003', name: 'PVC Pipes 4"', qty: 20, unitPrice: '65 GHS', lineTotal: '1,300 GHS' }],
  },
  {
    id: 'ORD-8973',
    ...
    credStatus: 'Settled',
    date: 'Yesterday',
    deliveryAddress: 'Tema Harbour, Yard 4',
    orderNotes: 'Export grade materials.',
    createdAt: '2026-03-27T09:00:00Z',
    updatedAt: '2026-03-27T15:00:00Z',
    items: [{ productId: 'PRD-002', name: 'Iron Rods 16mm', qty: 154, unitPrice: '120 GHS', lineTotal: '18,480 GHS' }],
  },
  {
    id: 'ORD-8972',
    ...
    credStatus: 'Settled',
    date: 'Yesterday',
    deliveryAddress: 'Airport Residential, Ridge Road',
    createdAt: '2026-03-27T14:30:00Z',
    updatedAt: '2026-03-27T16:00:00Z',
    orderNotes: 'Residential renovation.',
    items: [{ productId: 'PRD-001', name: 'Portland Cement 50kg', qty: 8, unitPrice: '85 GHS', lineTotal: '680 GHS' }],
  },
  {
    id: 'ORD-8971',
    customer: 'Metro Works GH',
    type: 'Wholesale',
    amount: '32,000 GHS',
    payStatus: 'Credit',
    ...
    credStatus: 'Active',
    date: 'Today, 08:45 AM',
    deliveryAddress: 'Accra, Ministries Area',
    createdAt: '2026-03-28T08:45:00Z',
    updatedAt: '2026-03-28T09:00:00Z',
    orderNotes: 'Government project site.',
    items: [{ productId: 'PRD-002', name: 'Iron Rods 16mm', qty: 266, unitPrice: '120 GHS', lineTotal: '31,920 GHS' }],
  },
  {
    id: 'ORD-8970',
    customer: 'City Hardware Madina',
    type: 'Wholesale',
    amount: '4,250 GHS',
    payStatus: 'Paid',
    paymentMethod: 'Cash',
    ...
    credStatus: 'Settled',
    date: '2 days ago',
    deliveryAddress: 'Madina Market, Shop 45',
    createdAt: '2026-03-26T11:15:00Z',
    updatedAt: '2026-03-26T14:30:00Z',
    orderNotes: 'Bulk paint for resale.',
    items: [{ productId: 'PRD-004', name: 'Emulsion Paint 20L', qty: 10, unitPrice: '450 GHS', lineTotal: '4,500 GHS' }],
  },
];
