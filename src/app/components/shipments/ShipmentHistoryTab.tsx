      ...
      <div className="bg-white rounded-[24px] border border-[#ECEDEF] overflow-hidden">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-[#F1F3F5]">
            {filtered.map((s) => (
              <tr key={s.id} className="hover:bg-[#FAFBFC] transition-all group cursor-pointer">
                ...
                <td className="px-8 py-5 text-right">
                   <button className="px-4 py-2 bg-white border border-[#ECEDEF] rounded-[10px] text-[12px] font-black text-[#111111] hover:border-[#D40073] transition-all">
                      Details
                   </button>
                </td>
              </tr>
